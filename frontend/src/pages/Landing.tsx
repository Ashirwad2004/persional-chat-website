...
export default function Landing() {
    return (
        <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 antialiased gradient-bg">
            <div className="layout-container flex h-full grow flex-col">
                ...
                <header className="flex items-center justify-between whitespace-nowrap border-b border-slate-200/50 dark:border-slate-800/50 px-6 py-4 lg:px-40 backdrop-blur-md sticky top-0 z-50">
                    ...
                    <div className="flex flex-1 justify-end gap-8 items-center">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="hidden sm:block h-10 w-10 rounded-full border-2 border-slate-100 dark:border-slate-800 bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCkXKdRWmW9VaC4H26W7YwU6d5uv5VxpA18iG4X4nhMR4fNb4zJsYU11puUTuMZlAwmbfuXOSuRGn4F7opF2E1Zmjqn4cv1C07tf3SH4bFtR-PcZCcxHQFvq-v9ARTgsd-mmzmrnPt23ltTgePXXHVly8-MD9PUDIDlTpGZb9I26j5YstX6bQr2lHkv1yRu7D43MEcxPS6HEoL_dsRQtr4OwfaZHv5pmrAmaSWg_ptcTgm5-RK3JfR1PEdbEfp77DHvwZhN3ERBzmqb")' }}></div>
                        </div>
                    </div>
                </header>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            <div className="flex flex-col gap-8">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Link to="/login" className="flex min-w-[160px] cursor-pointer items-center justify-center rounded-xl h-14 px-8 bg-primary text-white text-base font-bold shadow-xl shadow-primary/30 hover:scale-[1.02] transition-transform">
                                        Get Started
                                    </Link>
                                ...
                                <div className="relative bg-slate-900 rounded-2xl p-2 shadow-2xl border border-slate-700/50 aspect-video w-full overflow-hidden">
                                    <div className="w-full h-full bg-[#fdfbfb] dark:bg-slate-900 rounded-lg overflow-hidden flex">
                                        <div className="w-20 lg:w-48 bg-slate-50 dark:bg-slate-800/50 border-r border-slate-100 dark:border-slate-800 flex flex-col p-4 gap-6">
                                            <div className="flex items-center gap-3">
                                                <div className="h-8 w-8 rounded-lg bg-primary/20 text-primary flex items-center justify-center"><span className="material-symbols-outlined text-sm">auto_awesome</span></div>
                                                <div className="hidden lg:block h-3 w-20 bg-slate-200 dark:bg-slate-700 rounded"></div>
                                            </div>
                                            <div className="flex flex-col gap-4">
                                                <div className="flex items-center gap-3">
                                                    <div className="h-8 w-8 rounded-full bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAnqQRqIBn79ST0FMUpr5SsiGto31794zL5WNoGdYhAlu18z-Ht9xxi1CKv_dSE1e5EozitF719sAoDP6pHZzf5HkECMNLlC6Hafls_iMPUIcxMVajvjOLW8z35YnidEjnr2c2yBKZNVLousnN1b-dqbPQpTIrDPOaNsdM92IwbJMKMvJM3XZkfLw-30AZMQ7jhNgBdjSNRB0Jb0qh3aVW6Iv6ZpEfSWAox2xYdd4TMtD0hZZVdbhQd9EGXaB6z678TtFsc1vIYJyQn")' }}></div>
                                                    <div className="hidden lg:block h-2 w-16 bg-slate-200 dark:bg-slate-700 rounded"></div>
                                                </div>
                                                <div className="flex items-center gap-3 opacity-60">
                                                    <div className="h-8 w-8 rounded-full bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuA6x8dE7eFH8mwvORwhdiSbK911iR_QoaelTC8B48RTDTv167TDRCvOA2B31538deX-n4tRT0Tm51k-IDsBZZRw7vb3dcts_OcHwUj9m6W6fmevoX8gsUiBpGGBNe6KhhBXj-P8UnMOAJTDCDy0SHDUuewK_GGnIl9YNu_1L9gb3pKb-u7NFXh86QJYbi6PUeV6kQ0qiAlGXiGYiZpe0zHmnzENkAuOCFoogQUYEnFDk6Qd9FGc-aRTC9dXo1JOvo-XMIG1EK8Se8p9")' }}></div>
                                                    <div className="hidden lg:block h-2 w-16 bg-slate-200 dark:bg-slate-700 rounded"></div>
                                                </div>
                                                <div className="flex items-center gap-3 opacity-60">
                                                    <div className="h-8 w-8 rounded-full bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuD626Nulx7Ayzqd23djocXiwCKuusHiKP23zMwHXfdHZMAPHsfijjwT0VtaaOAmy8mCBKH4EPHnZDpgk-NFNOJQ15VruIlBOV2TjRiU9rlYZOBRPtD6WWalb8Sb6UBhOLUREj121QhFQkDDmGm7sr21KhjmN9yYugJFcG9xKbq7ohFZnTBqK6BhU19W8pAy09DvE0DI0yrmKbBA3LVZI3KN3LFJTgzUDZQ9ZORqNIyxZIq6CQh9GqAkzT7vxsJ52o95mjZITC8NsFTN")' }}></div>
                                                    <div className="hidden lg:block h-2 w-16 bg-slate-200 dark:bg-slate-700 rounded"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex-1 flex flex-col">
                                            ...
                                            <div className="p-4 border-t border-slate-100 dark:border-slate-800 w-full">
                        ...
                        <div className="relative bg-primary rounded-[2.5rem] p-12 lg:p-20 overflow-hidden">
                            ...
                            <div className="relative z-10 flex flex-col items-center text-center gap-8 max-w-3xl mx-auto">
                                ...
                                <div className="flex justify-center w-full">
                                    <Link to="/login" className="flex min-w-[200px] cursor-pointer items-center justify-center rounded-xl h-14 px-10 bg-white text-primary text-lg font-bold hover:scale-[1.05] transition-transform shadow-2xl">
                                        Create Free Account
                                    </Link>
                                </div>
                            </div>
                ...
                <footer className="px-6 lg:px-40 py-16 border-t border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-slate-100 dark:border-slate-800 gap-4">
                        <p className="text-slate-500 text-sm">© 2026 NexusChat Inc. All rights reserved.</p>
